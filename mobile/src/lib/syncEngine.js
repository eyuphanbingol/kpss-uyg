...
(function (global) {
    global.SupabaseClient = { get: function () { return supabase; } };
    global.KpssConfig = KpssConfig;
    if (!global.StudentStore) global.StudentStore = StudentStore;
    var timer = null;
    var syncing = false;
    ...
    async function pullPush() {
        ...
        try {
            ...
            var cfgDates = KpssConfig && KpssConfig.examDateByLevel;
...
export var SyncEngine = globalThis.SyncEngine;
