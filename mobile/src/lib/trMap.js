...
export function mapDocument(svgText, mode) {
    ...
    return "<!DOCTYPE html><html><head><meta charset=\"utf-8\"/>"
        ...
        + "if(path&&path.getBBox){try{var b=path.getBBox();if(b.width>1&&b.height>1){x=b.x+b.width/2+(Number(p.ox)||0)*b.width;y=b.y+b.height/2+(Number(p.oy)||0)*b.height;}}catch(e){}}}"
