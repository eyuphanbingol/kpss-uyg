...
import { localStorageShim as localStorage, sessionStorageShim as sessionStorage } from "./storage";
...
(function (global) {
    ...
    function migrate(parsed) {
        ...
        var officialDates = (KpssConfig && KpssConfig.examDateByLevel) || {
    ...
    function canStartMixed() {
        ...
        var cap = (KpssConfig && KpssConfig.freeDailyMixed) || 3;
        var u = todayUsage();
...
export var StudentStore = globalThis.StudentStore;
