        ...
        return (
            <div className="max-w-2xl mx-auto px-4 py-6 pb-10">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                    ...
                    <div className="rounded-2xl p-5 border-2 border-brand-gold bg-white dark:bg-slate-900 relative">
                        <span className="badge-gold absolute -top-2.5 left-4 text-[10px] uppercase tracking-wider px-2 py-0.5 rounded-full">En popüler</span>
                        <p className="text-sm text-zinc-500">Premium</p>
                        <p className="font-stat text-3xl mt-2 text-brand-navy dark:text-brand-goldsoft">149 ₺<span className="text-base font-sans font-medium text-zinc-400"> / ay</span></p>
                        ...
                        <button disabled={busy} onClick={buy} className="mt-5 w-full py-3 rounded-xl bg-brand-navy text-white font-semibold disabled:opacity-50">
                ...
                {mock ? (
                    <div className="mt-6 panel rounded-2xl p-4">
                        <div className="flex items-center justify-between mb-3">
                            ...
                            <span className="text-[10px] uppercase tracking-wide px-2 py-0.5 rounded-full bg-brand-amber/15 text-brand-amber">Test modu</span>
                        </div>
