...
(function () {
  ...
  var NOTE_COLORS = [{
    ...
    bg: "#fecdd3",
    border: "#fb7185",
    card: "bg-rose-50 dark:bg-rose-950/40 border-rose-200 dark:border-rose-800/50"
  }, {
    id: "amber",
    label: "Sarı",
    bg: "#fde68a",
    ...
    bg: "#a7f3d0",
    border: "#10b981",
    card: "bg-emerald-50 dark:bg-emerald-950/40 border-emerald-200 dark:border-emerald-800/50"
  }, {
    id: "sky",
    label: "Mavi",
    bg: "#bae6fd",
    border: "#0ea5e9",
    card: "bg-sky-50 dark:bg-sky-950/40 border-sky-200 dark:border-sky-800/50"
  }, {
    id: "violet",
    label: "Mor",
    bg: "#ddd6fe",
    border: "#8b5cf6",
    card: "bg-violet-50 dark:bg-violet-950/40 border-violet-200 dark:border-violet-800/50"
  }, {
    id: "slate",
    label: "Gri",
    bg: "#e2e8f0",
    border: "#64748b",
    card: "bg-slate-100 dark:bg-slate-900/50 border-slate-300 dark:border-slate-600"
  }];
  ...
  function applyBold(val, start, end) {
    ...
    if (sel.length > 4 && sel.slice(0, 2) === "**" && sel.slice(-2) === "**") {
      ...
      return {
        val: val.slice(0, start) + inner + val.slice(end),
        start: start,
    ...
    if (start >= 2 && val.slice(start - 2, start) === "**" && val.slice(end, end + 2) === "**") {
      return {
        val: val.slice(0, start - 2) + sel + val.slice(end + 2),
        start: start - 2,
        end: end - 2
      };
    }
    return {
      val: val.slice(0, start) + "**" + sel + "**" + val.slice(end),
      start: start,
      end: end + 4
    };
  }
  function RichText(props) {
    ...
    while (m = re.exec(text)) {
      ...
      nodes.push(/*#__PURE__*/React.createElement("b", {
        key: "b" + i++,
  ...
  function ReviewNotebook(props) {
    ...
    const notes = useMemo(function () {
      return window.StudentStore && window.StudentStore.listReviewNotes ? window.StudentStore.listReviewNotes() : (student.reviewNotebook || []).filter(function (n) {
        return n && !n.deleted;
      });
    }, [student]);
    const dersOptions = useMemo(function () {
      var keys = Object.keys(kpssData || {}).filter(function (k) {
        return k && k !== "_";
      });
    ...
    var filtered = useMemo(function () {
      ...
      if (filterDers === "genel") return notes.filter(function (n) {
        return !n.ders;
      });
      return notes.filter(function (n) {
        return n.ders === filterDers;
      });
    }, [notes, filterDers]);
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "text-2xl md:text-3xl font-display font-black tracking-tight gradient-text"
    }, "Tekrar defteri"), /*#__PURE__*/React.createElement("p", {
      className: "text-sm text-stone-400 mt-1"
    }, "Ders ders ay\u0131r, renklendir. Karakter s\u0131n\u0131r\u0131 yok. Yaln\u0131zca sen g\xF6r\xFCrs\xFCn.")), props.onBack ? /*#__PURE__*/React.createElement(BackBtn, {
      onClick: props.onBack,
      label: "Geri"
    }) : null), /*#__PURE__*/React.createElement("div", {
      className: "rounded-3xl glass p-5 mb-5"
    }, /*#__PURE__*/React.createElement("p", {
      className: "text-xs font-bold uppercase tracking-wider text-stone-400 mb-3"
    }, editId ? "Notu düzenle" : "Yeni not"), /*#__PURE__*/React.createElement("label", {
      className: "block text-[11px] font-bold uppercase tracking-wider text-stone-400 mb-1"
    }, "Ders"), /*#__PURE__*/React.createElement("select", {
      value: ders,
      onChange: function (e) {
      ...
      value: ""
    }, "Genel"), dersOptions.map(function (d) {
      ...
      className: "flex flex-wrap gap-2 mt-2 mb-2 items-center"
      ...
      title: "Se\xE7ili metni kal\u0131n yap"
    }, "K Kal\u0131n"), /*#__PURE__*/React.createElement("span", {
      className: "text-[11px] text-stone-400"
    }, "Renk:"), NOTE_COLORS.map(function (c) {
      var on = color === c.id;
    ...
    }, "Kaydet"), editId ? /*#__PURE__*/React.createElement("button", {
      type: "button",
      onClick: resetForm,
      className: "px-4 py-3 rounded-xl border-2 border-stone-200 text-sm font-medium"
    }, "Vazge\xE7") : null)), notes.length > 0 ? /*#__PURE__*/React.createElement("div", {
      ...
      className: "px-3 py-1.5 rounded-full text-xs font-bold border " + (filterDers === "all" ? "bg-teal-600 text-white border-teal-600" : "border-stone-200 dark:border-stone-600")
    }, "T\xFCm\xFC"), /*#__PURE__*/React.createElement("button", {
      type: "button",
      onClick: function () {
        setFilterDers("genel");
      },
      className: "px-3 py-1.5 rounded-full text-xs font-bold border " + (filterDers === "genel" ? "bg-teal-600 text-white border-teal-600" : "border-stone-200 dark:border-stone-600")
    }, "Genel"), dersOptions.map(function (d) {
      ...
      }, dersLabel(d), " \xB7 ", count);
    })) : null, filtered.length === 0 ? /*#__PURE__*/React.createElement("div", {
      className: "rounded-3xl border border-dashed border-stone-200 dark:border-stone-700 p-6 text-center"
    }, /*#__PURE__*/React.createElement("p", {
      className: "text-sm text-stone-500"
    }, notes.length ? "Bu derste not yok." : "Henüz not yok. Yukarıya yazıp kaydet.")) : /*#__PURE__*/React.createElement("div", {
      className: "space-y-6"
    }, grouped.map(function (g) {
      return /*#__PURE__*/React.createElement("div", {
        key: g.ders || "genel"
      }, /*#__PURE__*/React.createElement("h2", {
        className: "text-xs font-black uppercase tracking-widest text-stone-400 mb-2"
      }, dersLabel(g.ders)), /*#__PURE__*/React.createElement("div", {
        className: "space-y-3"
      }, g.items.map(function (n, ni) {
        var cm = colorMeta(n.color);
        return /*#__PURE__*/React.createElement("div", {
          key: n.id,
          className: "rounded-2xl border p-4 " + (cm.card || "glass") + " " + (editId === n.id ? "ring-2 ring-teal-600/30" : "")
        }, /*#__PURE__*/React.createElement("div", {
        ...
        }, fmtWhen(n.updatedAt))), /*#__PURE__*/React.createElement("div", {
          ...
          className: "px-2 py-1 rounded-lg text-xs font-black border border-stone-200 dark:border-stone-600 disabled:opacity-30",
          title: "Yukar\u0131"
        }, "\u2191"), /*#__PURE__*/React.createElement("button", {
          type: "button",
          disabled: ni === g.items.length - 1,
          onClick: function () {
            moveNote(n.id, 1);
          },
          className: "px-2 py-1 rounded-lg text-xs font-black border border-stone-200 dark:border-stone-600 disabled:opacity-30",
          ...
          className: "px-2.5 py-1 rounded-lg text-xs font-medium text-teal-700 dark:text-teal-300"
        }, "D\xFCzenle"), /*#__PURE__*/React.createElement("button", {
          type: "button",
          onClick: function () {
            remove(n.id);
          },
          className: "px-2.5 py-1 rounded-lg text-xs font-medium text-rose-600"
        }, "Sil"))), /*#__PURE__*/React.createElement("p", {
          className: "text-sm whitespace-pre-wrap mt-2 text-stone-700 dark:text-stone-200"
        }, /*#__PURE__*/React.createElement(RichText, {
          text: n.body
        })));
      })));
