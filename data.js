    ...
    return {
        "Tarih": {
            ...
            "20.YY Başlarında Osmanlı Devleti ":{
                notlar:window.tarih_11_notlari || [],
                sorular:window.tarih_11_sorulari || [] 
            },
            "Mondros Ateşkes Antlaşması ve Cemiyetler":{
                notlar:window.tarih_12_notlari || [],
                sorular:window.tarih_12_sorulari || [] 
            },
            ...
            "Genel Tekrar":{
                notlar: window.tarih_29_notlari || [],
                sorular: window.tarih_29_sorulari || []
            },
        },
        "Coğrafya": {
...
// Konu görünen adları. Anahtarlar (yukarıdaki konu adları) kullanıcı ilerlemesinin kimliğidir;
// ASLA değiştirilmez. Yalnızca ekranda yazım düzeltilmiş ad gösterilir.
window.KONU_LABELS = {
...
window.konuLabel = function (konu) {
    var k = String(konu == null ? "" : konu);
    return window.KONU_LABELS[k] || k.trim();
};
