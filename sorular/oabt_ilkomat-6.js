// sorular/oabt_ilkomat-6.js - Matematiksel Yapıların Temelleri
window.oabt_ilkomat_6_sorulari = [
{
    "question": "n elemanlı kümenin kuvvet kümesi kaç elemanlıdır?",
    "options": ["A) n!", "B) 2n", "C) n", "D) 2^n", "E) n^2"],
    "correctAnswerIndex": 3,
    "explanation": "Her eleman alınır/alınmaz: 2 seçenek."
},
{
    "question": "De Morgan kuralı hangisidir?",
    "options": ["A) (A∪B)' = A' ∪ B'", "B) (A∩B)' = A' ∩ B'", "C) A∪A' = ∅", "D) A∩U = ∅", "E) (A∪B)' = A' ∩ B'"],
    "correctAnswerIndex": 4,
    "explanation": "Tümleyen birleşimi kesişime çevirir."
},
{
    "question": "p→q önermesinin eşdeğeri hangisidir?",
    "options": ["A) ¬p → ¬q", "B) p ∧ ¬q", "C) ¬p ∧ q", "D) ¬q → ¬p (karşıt ters)", "E) q → p (karşıt)"],
    "correctAnswerIndex": 3,
    "explanation": "Kontrapozitif eşdeğer; konvers değil."
},
{
    "question": "Evrensel önermeyi tek örnekle kanıtlamak neden yetmez?",
    "options": ["A) Kümeler sonlu olamaz", "B) ∀ iddiası tüm elemanları ister; örnek yalnızca ∃ kanıtlar", "C) Örnek hiç işe yaramaz", "D) Tümevarım yasaktır", "E) Çelişki tek yöntemdir"],
    "correctAnswerIndex": 1,
    "explanation": "Karşı örnek evrenseli çürütür."
},
{
    "question": "Denklik bağıntısının üç özelliği nedir?",
    "options": ["A) Yansıma, simetri, geçişme", "B) Yansıma, antisimetri, geçişme", "C) Yalnızca simetri", "D) Kapalılık ve birim", "E) İyi sıralama"],
    "correctAnswerIndex": 0,
    "explanation": "Kısmi sıra antisimetrik; denklik simetriktir."
},
{
    "question": "Cantor'un çapraz argümanı neyi gösterir?",
    "options": ["A) Asalların sonlu olduğunu", "B) Z'nin sayılamaz olduğunu", "C) Reel sayıların sayılamaz sonsuz olduğunu", "D) Q'nun sonlu olduğunu", "E) N'nin sınırsız olmadığını"],
    "correctAnswerIndex": 2,
    "explanation": "Q sayılabilir; R kontinuum."
},
{
    "question": "Grup aksiyomlarından biri hangisidir?",
    "options": ["A) Topoloji", "B) Her elemanın tersinin olması", "C) Sıfır bölen olması", "D) Sıralama olması", "E) Sayılabilirlik"],
    "correctAnswerIndex": 1,
    "explanation": "Kapalılık, birleşme, birim, ters."
},
{
    "question": "Matematiksel tümevarımın iki basamağı nedir?",
    "options": ["A) Graf çizmek", "B) Ortalama almak", "C) Başlangıç (n=1 veya 0) ve indükleme adımı", "D) Yalnızca örnek vermek", "E) Yalnızca çelişki"],
    "correctAnswerIndex": 2,
    "explanation": "P(k)⇒P(k+1) tüm doğal sayılara taşır."
},
{
    "question": "¬∃x P(x) eşdeğeri nedir?",
    "options": ["A) P(x) ∧ ¬P(x)", "B) ∀x ¬P(x)", "C) ∃x ¬P(x)", "D) ∀x P(x)", "E) ¬∀x ¬P(x)"],
    "correctAnswerIndex": 1,
