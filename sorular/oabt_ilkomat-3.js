// sorular/oabt_ilkomat-3.js - Geometri
window.oabt_ilkomat_3_sorulari = [
{
    "question": "Öklid düzleminde üçgenin iç açıları toplamı nedir?",
    "options": ["A) 180 derece", "B) 90 derece", "C) 270 derece", "D) 360 derece", "E) 120 derece"],
    "correctAnswerIndex": 0,
    "explanation": "Küresel geometride toplam 180'den büyüktür; ÖABT tuzak."
},
{
    "question": "SSA neden genel eşlik kriteri değildir?",
    "options": ["A) Açıortay bozar", "B) Pisagor çelişir", "C) İki kenar ve bunlardan birine karşı açı belirsiz (iki üçgen) durum yaratabilir", "D) Hiçbir zaman üçgen oluşturmaz", "E) Yalnızca eşkenar üçgende geçersizdir"],
    "correctAnswerIndex": 2,
    "explanation": "Ambiguous case: 0, 1 veya 2 üçgen."
},
{
    "question": "Pisagor teoreminin tersi ne söyler?",
    "options": ["A) a^2+b^2=c^2 ise c'nin karşısı dik açıdır", "B) Üçgen eşkenardır", "C) Üçgen geniş açılıdır", "D) Çember oluşur", "E) Alan sıfırdır"],
    "correctAnswerIndex": 0,
    "explanation": "Diklik kriteri olarak kullanılır."
},
{
    "question": "Teğet-yarıçap ilişkisi nedir?",
    "options": ["A) Teğet merkeze paralelse yarıçapa dik değildir", "B) Teğet, değme noktasındaki yarıçapa diktir", "C) Teğet yarıçapla çakışır", "D) Teğet kirişi ortalar her zaman", "E) Teğet çapı uzatır"],
    "correctAnswerIndex": 1,
    "explanation": "Klasik çember özelliği."
},
{
    "question": "Benzer üçgenlerde karşılıklı kenarlar nasıldır?",
    "options": ["A) Orantılıdır", "B) Eşittir", "C) Diktir", "D) Toplamları 180'dir", "E) Paralel olmak zorunda değildir ve orantısızdır"],
    "correctAnswerIndex": 0,
    "explanation": "Açılar eşit, kenarlar k oranındadır."
},
{
    "question": "Konveks çokyüzlüde Euler bağıntısı hangisidir?",
    "options": ["A) V = E + F", "B) F = 2E", "C) V - E + F = 2", "D) V + E + F = 2", "E) V - E - F = 0"],
    "correctAnswerIndex": 2,
    "explanation": "Küp: 8-12+6=2."
},
{
    "question": "İzometri dönüşüm hangisidir?",
    "options": ["A) Alanı iki katlayan gerinim", "B) Projeksiyon", "C) Sıkıştırma", "D) Yansıma", "E) Homoteti k≠1"],
    "correctAnswerIndex": 3,
    "explanation": "Öteleme, dönme, yansıma uzunluk korur; homoteti benzerliktir."
},
{
    "question": "Sinüs teoremi nedir?",
    "options": ["A) çevre=πd", "B) a/sin A = b/sin B = c/sin C = 2R", "C) a^2=b^2+c^2-2bc cos A yalnız", "D) sin^2+cos^2=0", "E) Alan=ab"],
    "correctAnswerIndex": 1,
    "explanation": "Kosinüs teoremi kenar-açı-kenar çözümler."
},
{
    "question": "Aykırı doğrular uzayda nasıldır?",
    "options": ["A) Çakışıktırlar", "B) Her zaman kesişirler", "C) Düzlemde paraleldirler", "D) Ne kesişir ne paraleldir, aynı düzlemde değillerdir", "E) Dik kesişirler"],
    "correctAnswerIndex": 3,
