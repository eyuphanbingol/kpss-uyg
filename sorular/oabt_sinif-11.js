// sorular/oabt_sinif-11.js - Türkçe Öğretimi
window.oabt_sinif_11_sorulari = [
{
    "question": "Yazma sürecinin ikinci basamağı nedir?",
    "options": ["A) Yalnızca temize çekmek", "B) Ezber şiir", "C) Dikte tek", "D) Taslak yazma", "E) Hemen not vermek"],
    "correctAnswerIndex": 3,
    "explanation": "Plan-taslak-düzelt."
},
{
    "question": "Eleştirel okuma ilkokulda nasıl sadeleşir?",
    "options": ["A) Okumama", "B) Ezberleme tek", "C) Harf sayma", "D) Yazarın amacı ve kanıtı sorgulama", "E) Metni yırtma"],
    "correctAnswerIndex": 3,
    "explanation": "Medya da dahildir."
},
{
    "question": "Grafik örgütleyici ne işe yarar?",
    "options": ["A) Yoklama", "B) Punto", "C) Metin yapısını görselleştirmek", "D) Süs", "E) Ceza"],
    "correctAnswerIndex": 2,
    "explanation": "Özet ve karşılaştırma."
},
{
    "question": "Söz varlığı morfemle nasıl genişler?",
    "options": ["A) Sessizlik", "B) Ek ve kök farkındalığı", "C) Kopuk 100 kelime listesi tek", "D) Bağlam yok ezber", "E) Ceza"],
    "correctAnswerIndex": 1,
    "explanation": "Dil bilgisi işlevsel."
},
{
    "question": "Dislekside alay neden etik ihlaldir?",
    "options": ["A) Güvenirliği artırması", "B) Hızı artırması", "C) Notu nesnelleştirmesi", "D) Aileyi mutlu etmesi", "E) Öğrenme farkını utanca çevirmesi"],
    "correctAnswerIndex": 4,
    "explanation": "Kapsayıcılık."
},
{
    "question": "Dinleme eğitimi sessiz oturmak mıdır?",
    "options": ["A) Evet ceza", "B) Evet yasak konuşma sonsuz", "C) Hayır, amaçlı anlama ve tepki", "D) Evet tek kural", "E) Evet ezber"],
    "correctAnswerIndex": 2,
    "explanation": "Aktif dinleme."
},
{
    "question": "Paylaşarak okumanın yararı nedir?",
    "options": ["A) Hız yarışı utancı", "B) Tek öğrenci tekel", "C) Sessiz ceza", "D) Akıcı model ve ortak anlam", "E) Kopya"],
    "correctAnswerIndex": 3,
    "explanation": "Akıcılık."
},
{
    "question": "İki dilli öğrenci Türkçe dersinde nasıl görülür?",
    "options": ["A) Not sıfır", "B) Arka sıra", "C) Dilsel varlık ve köprü", "D) Eksik vatandaş", "E) Yasak ana dil"],
    "correctAnswerIndex": 2,
    "explanation": "Kapsayıcı dil."
},
{
    "question": "Konuşma rubriği neyi içerir?",
    "options": ["A) Yalnızca şive alayı", "B) Yalnızca kılık", "C) Yalnızca not ortalaması", "D) Yalnızca boy", "E) İçerik, akıcılık, nezaket, ses"],
    "correctAnswerIndex": 4,
    "explanation": "Ölçme."
},
{
    "question": "Türkçe dersinin omurgası nedir?",
    "options": ["A) Yalnızca imla yarışı", "B) Dört temel dil becerisi", "C) Yalnızca dil bilgisi kural listesi", "D) Yalnızca dikte", "E) Yalnızca ezber şiir"],
    "correctAnswerIndex": 1,
    "explanation": "Program."
},
{
