// sorular/tarih-27.js — YUMUŞAMA DÖNEMİ (1961–1990)
window.tarih_27_sorulari = [
    {
    ...
    },
    {
        ...
        options: [
            "A) Hiç imzalanmadı",
            "B) İmzalandı fakat ABD Senatosu onaylamadı / tam yürürlüğe giremedi",
            "C) Afganistan işgali nedeniyle daha önce 1961’de iptal edildi",
            "D) Yalnız Çin ile imzalandı",
            "E) Helsinki Nihai Senedi’nin diğer adıdır"
        ],
        correctAnswerIndex: 1,
    ...
    {
        question: "Bandung Konferansı (1955) için hangisi YANLIŞTIR?",
        options: [
            "A) Endonezya’nın Bandung kentinde yapıldı",
            "B) Bağlantısızlar Hareketi’nin temelleri atıldı",
            "C) 29 Asya–Afrika ülkesi katıldı",
            "D) 55 Avrupa ülkesi katıldı",
            "E) Sukarno ev sahibi liderlerdendir"
        ],
        correctAnswerIndex: 3,
        explanation: "29 Asya–Afrika ülkesi. 55 ülke ifadesi kullanılmamalı. İlk Bağlantısızlar zirvesi 1961 Belgrad’dır."
    },
    {
        question: "Bağlantısızlar Hareketi’nin ilk zirvesi nerede ve ne zaman yapılmıştır?",
        options: ["A) Bandung 1955", "B) Belgrad 1961", "C) Viyana 1961", "D) Helsinki 1975", "E) Kahire 1956"],
        correctAnswerIndex: 1,
        explanation: "Bandung temeli 1955; ilk zirve 1961 Belgrad. Viyana 1961 Kennedy–Kruşçev’dir."
    },
    {
        question: "Bağlantısızlar’ın öne çıkan lider eşleştirmelerinden hangisi yanlıştır?",
        options: [
            "A) Mısır – Nâsır",
            "B) Hindistan – Nehru",
            "C) Yugoslavya – Tito",
        ...
        explanation: "Endonezya Sukarno’dur. Mao Çin komünist lideridir, Bağlantısızlar çekirdeği değildir."
    },
    {
        question: "Helsinki Nihai Senedi hangi yıldadır?",
        options: ["A) 1961", "B) 1968", "C) 1972", "D) 1975", "E) 1979"],
        correctAnswerIndex: 3,
    ...
    {
        question: "1967 Altı Gün Savaşı’nda İsrail’in Suriye’den kontrol sağladığı yer hangisidir?",
        options: ["A) Sina", "B) Golan Tepeleri", "C) Kıbrıs", "D) Kuveyt", "E) Kardak"],
        correctAnswerIndex: 1,
        explanation: "İsrail Mısır, Suriye, Ürdün ile savaştı; Batı Şeria, Doğu Kudüs, Gazze, Golan, Sina."
    },
    {
    ...
    },
    {
        ...
        options: ["A) 1964", "B) 1974", "C) 1976", "D) 1995", "E) 1996"],
        correctAnswerIndex: 3,
    ...
    {
        question: "Dr. Fazıl Küçük’ün 1960 Kıbrıs Cumhuriyeti’ndeki görevi hangisidir?",
        options: ["A) Başbakan", "B) Cumhurbaşkanı", "C) Cumhurbaşkanı yardımcısı", "D) Dışişleri bakanı", "E) EOKA komutanı"],
        correctAnswerIndex: 2,
    ...
    {
        question: "Kanlı Noel hangi yıldadır?",
        options: ["A) 1959", "B) 1960", "C) 1963", "D) 1964", "E) 1974"],
        correctAnswerIndex: 2,
    ...
    {
        question: "ABD’nin Türkiye’ye silah ambargosu hangi gelişmeden sonra ve hangi yılda uygulanmıştır?",
        options: ["A) 1964 Johnson – 1964", "B) 1974 Harekâtı sonrası 1975", "C) 1983 KKTC – 1983", "D) 12 Eylül – 1980", "E) Kardak – 1996"],
        correctAnswerIndex: 1,
        explanation: "Kongre 1975 ambargosu; Türkiye ABD’nin Türkiye’deki askerî faaliyetlerine kısıt getirdi."
    },
    {
        question: "KKTC hangi tarihte ilan edilmiştir?",
        options: ["A) 20 Temmuz 1974", "B) 15 Kasım 1983", "C) 1987", "D) 24 Nisan 2004", "E) 15 Temmuz 1974"],
        correctAnswerIndex: 1,
    ...
    {
        question: "Nükleer Silahların Yayılmasını Önleme Antlaşması (NPT) hangi yıldadır?",
        options: ["A) 1961", "B) 1967", "C) 1968", "D) 1972", "E) 1979"],
        correctAnswerIndex: 2,
    ...
    },
    {
        ...
        options: [
            "A) Kennedy–Kruşçev: 1961 Viyana",
            "B) SALT-I: 1972",
            "C) Kanlı Noel: 1964",
            "D) KKTC: 15 Kasım 1983",
            "E) Annan Planı: 2004"
        ],
        correctAnswerIndex: 2,
    ...
    },
    {
        ...
        options: ["A) 1957", "B) 1961", "C) 1967", "D) 1969", "E) 1983"],
        correctAnswerIndex: 2,
    ...
    {
        question: "I. 1961 Viyana Kennedy–Kruşçev\nII. 1961 Belgrad Bağlantısızlar zirvesi\nIII. 1961 Viyana’da SALT-I imzası\nHangileri doğrudur?",
        options: ["A) Yalnız I", "B) Yalnız II", "C) I ve II", "D) I ve III", "E) I, II ve III"],
        correctAnswerIndex: 2,
        explanation: "III yanlış: SALT-I 1972’dir, 1961 Viyana’da imzalanmamıştır."
    },
    {
    ...
    {
        question: "Altı Gün Savaşı’nda İsrail’in kontrol sağladığı yerler arasında hangisi yoktur?",
        options: ["A) Batı Şeria", "B) Doğu Kudüs", "C) Gazze", "D) Golan Tepeleri", "E) Kuveyt"],
        correctAnswerIndex: 4,
        explanation: "Kuveyt 1990 Irak işgali / Körfez Savaşı konusudur. Sina da 1967’de İsrail kontrolüne girdi."
    },
    {
        question: "I. Ping-Pong Diplomasisi ABD–Çin’dir.\nII. Nixon 1972’de Çin’i ziyaret etmiştir.\nIII. Bu süreç Çin’in uluslararası sisteme yeniden yaklaşmasına katkı sağlamıştır.\nHangileri doğrudur?",
        options: ["A) Yalnız I", "B) I ve II", "C) II ve III", "D) I ve III", "E) I, II ve III"],
        correctAnswerIndex: 4,
        explanation: "1971 temaslar, 1972 ziyaret, diplomatik açılım."
    },
    {
        question: "Helsinki Nihai Senedi’nin ilkeleri arasında hangisi yer almaz?",
        options: [
            "A) Egemenliğe saygı",
            "B) Toprak bütünlüğü",
            "C) Kuvvet kullanmama ve barışçıl çözüm",
            "D) İnsan hakları ve temel özgürlükler",
            "E) Varşova Paktı’na zorunlu üyelik"
        ],
        correctAnswerIndex: 4,
    ...
    {
        question: "Neil Armstrong’un Ay’a ayak basması hangi program ve yıldadır?",
        options: ["A) Vostok-I 1961", "B) Apollo-11 1969", "C) Sputnik-I 1957", "D) SDI 1983", "E) ARPANET 1969"],
        correctAnswerIndex: 1,
        explanation: "ABD Apollo-11; Ay’a insan gönderilmesi."
    },
    {
        question: "12 Eylül sonrası siyasi kısıtlamaya uğrayan liderler arasında hangisi yoktur?",
        options: ["A) Süleyman Demirel", "B) Bülent Ecevit", "C) Necmettin Erbakan", "D) Alparslan Türkeş", "E) Rauf Denktaş"],
        correctAnswerIndex: 4,
        explanation: "Denktaş Kıbrıs/KKTC lideridir; 12 Eylül’ün dört parti lideri listesinde değildir."
    }
];
