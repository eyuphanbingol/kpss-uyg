window.tarih_9_sorulari = [
    {
        question: "XIX. yüzyıl Osmanlı Devleti dağılma döneminde izlenen temel dış politika aşağıdakilerden hangisidir?",
        options: ["A) Fetih politikası", "B) İttihad-ı anasır", "C) Panislamizm", "D) Denge politikası", "E) Kapitülasyon kaldırma"],
    ...
    {
        question: "1804 Sırp İsyanı ile ilgili aşağıdakilerden hangisi doğrudur?",
    ...
    {
        question: "Milliyetçilik etkisi ile isyan eden ilk Osmanlı azınlığı aşağıdakilerden hangisidir?",
        options: ["A) Rumlar", "B) Bulgarlar", "C) Arnavutlar", "D) Ermeniler", "E) Sırplar"],
        correctAnswerIndex: 4,
        explanation: "Kara Yorgi önderliğindeki 1804 Sırp İsyanı, milliyetçilik etkisiyle isyan eden ilk azınlıktır."
    },
    {
        question: "1806–1812 Osmanlı–Rus Savaşı'nın sonucunda imzalanan antlaşma aşağıdakilerden hangisidir?",
    ...
    {
        question: "Milliyetçilik etkisi ile imtiyaz kazanan ilk azınlık aşağıdakilerden hangisidir?",
    ...
    {
        question: "Sırpların bağımsızlık aşamaları aşağıdakilerin hangisinde doğru sıralanmıştır?",
        options: [
    ...
    {
        question: "Sırpların özerk hale geldikleri antlaşma hangisidir?",
    ...
    {
        question: "1815 Viyana Kongresi ile ilgili aşağıdakilerden hangisi söylenemez?",
        options: [
    ...
    {
        question: "İlk defa Şark Sorunu'nun gündeme geldiği toplantı aşağıdakilerden hangisidir?",
    ...
    {
        question: "Yunanlıların isyan ettiği başlıca bölgeler aşağıdakilerin hangisinde doğru verilmiştir?",
        options: ["A) Mora ve ardından Eflak", "B) Sırbistan ve Karadağ", "C) Yanya ve Girit", "D) Teselya ve Kıbrıs", "E) Eflak ve sonrasında Mora"],
        correctAnswerIndex: 4,
    ...
    {
        question: "Kavalalı Mehmet Ali Paşa Yunan İsyanına yardım karşılığında hangilerini istemiştir?",
        options: ["A) Şam ve Adana", "B) Trablusgarp ve Tunus", "C) Cidde ve Hicaz", "D) Suriye ve Irak", "E) Mora ve Girit"],
        correctAnswerIndex: 4,
        explanation: "Kavalalı, Mora ve Girit'in kendisine verilmesi karşılığında yardım etmiş ve isyan bastırılmıştır."
    },
    {
        question: "Navarin Baskını'nda Osmanlı donanmasını yakan devletler hangileridir?",
    ...
    {
        question: "Milliyetçilik etkisi ile Osmanlı Devleti'nden ayrılan ilk azınlık hangisidir?",
        options: ["A) Sırplar", "B) Karadağlılar", "C) Bulgarlar", "D) Romenler", "E) Yunanlılar"],
        correctAnswerIndex: 4,
    ...
    },
    {
        ...
        options: [
            ...
            "E) Girit ve Mora yerine Girit ve Suriye valiliklerini istemesi ve Osmanlı'yı mağlup etmesi"
        ],
        correctAnswerIndex: 4,
    ...
    {
        question: "II. Mahmut'un «Denize düşen yılana sarılır» sözü hangi antlaşma ile ilişkilidir?",
    ...
    {
        question: "8 Temmuz 1833 Hünkâr İskelesi Antlaşması'na göre Rusya saldırıya uğrarsa Osmanlı ne yapacaktır?",
        options: [
            "A) Rusya'ya asker gönderecektir",
            "B) Kapitülasyonları kaldıracaktır",
            "C) Mısır'ı Rusya'ya bırakacaktır",
            "D) Rusya lehine boğazları kapatacaktır",
    ...
    {
        question: "Osmanlı Devleti'nin boğazlar üzerindeki egemenlik haklarını son kez tek başına kullandığı antlaşma hangisidir?",
        options: ["A) Londra Boğazlar Sözleşmesi", "B) Ayastefanos Antlaşması", "C) Paris Antlaşması", "D) Balta Limanı Antlaşması", "E) Hünkâr İskelesi Antlaşması"],
        correctAnswerIndex: 4,
    ...
    {
        question: "1838 Balta Limanı Ticaret Antlaşması hangi devletler arasında imzalanmıştır?",
    ...
    {
        question: "Balta Limanı Antlaşması'nın sonuçları arasında aşağıdakilerden hangisi yoktur?",
        options: [
    ...
    {
        question: "Lonca Teşkilatı'nın çökmesine yol açan antlaşma hangisidir?",
        options: ["A) Balta Limanı", "B) Hünkâr İskelesi", "C) Paris", "D) Berlin", "E) Kütahya"],
        correctAnswerIndex: 0,
    ...
    },
    {
        ...
        options: [
            ...
            "D) Mısır Meselesinin görüşüleceği Londra Konferansı kararlarında etkili olabilmek",
    ...
    },
    {
        ...
        options: ["A) 1841 Londra Boğazlar Sözleşmesi", "B) Hünkâr İskelesi Antlaşması", "C) 1856 Paris Antlaşması", "D) 1878 Berlin Antlaşması", "E) Balta Limanı Antlaşması"],
        correctAnswerIndex: 0,
        explanation: "1841 Londra Boğazlar Sözleşmesi ile boğazlar ilk kez uluslararası sorun olmuştur."
    },
    {
        question: "Osmanlı Devleti'ne «Hasta Adam» diyen ve Kırım Savaşı'nın nedenleri arasında yer alan kişi kimdir?",
    ...
    {
        question: "Kırım Savaşı'nın nedenleri arasında aşağıdakilerden hangisi yoktur?",
        options: [
    ...
    },
    {
        ...
        options: ["A) Navarin Baskını", "B) Çeşme Baskını", "C) Reval", "D) Sinop Baskını", "E) 31 Mart"],
        correctAnswerIndex: 3,
        explanation: "Kırım Savaşı'nda Osmanlı donanması Sinop Baskını'nda yakılmıştır. Navarin 1827'dedir."
    },
    {
        question: "Osmanlı Devleti'nde ilk kez dış borç hangi savaşta ve hangi devletten alınmıştır?",
    ...
    {
        question: "Osmanlı Devleti'nde ilk telgraf hattı hangi güzergâhta kurulmuştur?",
        options: ["A) İstanbul–Edirne–Şumnu", "B) İstanbul–İzmir–Selanik", "C) İstanbul–Ankara–Konya", "D) İstanbul–Bursa–Eskişehir", "E) İstanbul–Bağdat"],
        correctAnswerIndex: 0,
        explanation: "Kırım Savaşı sırasında ilk telgraf hattı İstanbul–Edirne–Şumnu'dur."
    },
    {
        question: "Selimiye Kışlasında modern hemşireliğin kurucusu olarak öne çıkan kişi kimdir?",
        options: ["A) Florence Nightingale", "B) Nene Hatun", "C) Halide Edip", "D) Kara Fatma", "E) Tepedelenli"],
        correctAnswerIndex: 0,
    ...
    {
        question: "Tanzimat ve Islahat fermanlarının ilan gerekçelerindeki ortak yön nedir?",
        options: [
    ...
    {
        question: "1856 Paris Antlaşması'na göre Osmanlı toprak bütünlüğünün Avrupalılarca korunması hangi yoruma götürür?",
        options: [
            "A) Osmanlı kendi toprak bütünlüğünü koruyamayacak kadar güçsüzdür",
            "B) Osmanlı Avrupa'nın en güçlü devletidir",
    ...
    {
        question: "93 Harbi'nin başlamasında Tersane Konferansı ile ilgili hangisi doğrudur?",
        options: [
    ...
    {
        question: "93 Harbi'nde Kafkas Cephesi'nde Ruslara direnen komutan kimdir?",
        options: ["A) Gazi Osman Paşa", "B) Tepedelenli Ali Paşa", "C) Süleyman Hüsnü Paşa", "D) Gazi Ahmet Muhtar Paşa", "E) Kavalalı Mehmet Ali Paşa"],
        correctAnswerIndex: 3,
        explanation: "Kafkas Cephesi'nde Ruslara direnen Gazi Ahmet Muhtar Paşa'dır."
    },
    {
        question: "Erzurum Aziziye Tabyasında direnişin sembolü olan kişi kimdir?",
        options: ["A) Nene Hatun", "B) Florence Nightingale", "C) Kara Yorgi", "D) Halepa", "E) Lord Byron"],
        correctAnswerIndex: 0,
        explanation: "Aziziye Tabyasında direnişin sembolü Nene Hatun'dur."
    },
    {
        question: "93 Harbi'nde Plevne Müdafii olarak bilinen kişi kimdir?",
    ...
    {
        question: "93 Harbi sonunda imzalanan antlaşma hangisidir?",
        options: ["A) Berlin Antlaşması", "B) Edirne Antlaşması", "C) Paris Antlaşması", "D) Ayastefanos (Yeşilköy) Antlaşması", "E) Uşi Antlaşması"],
        correctAnswerIndex: 3,
        explanation: "Ağır mağlubiyet sonrası Ayastefanos (Yeşilköy) Antlaşması imzalanmıştır; ardından Berlin'de yumuşatılmıştır."
    },
    {
        question: "1878 Berlin Antlaşması'nda Osmanlı'nın yardım karşılığında geçici olarak İngiltere'ye bıraktığı yer hangisidir?",
        options: ["A) Kıbrıs", "B) Mısır", "C) Girit", "D) Bosna", "E) Teselya"],
        correctAnswerIndex: 0,
    ...
    {
        question: "Berlin Antlaşması ile bağımsız olan devletler hangileridir?",
        options: ["A) Yunanistan, Sırbistan, Bulgaristan", "B) Sırbistan, Yunanistan, Mısır", "C) Bulgaristan, Bosna, Girit", "D) Cezayir, Tunus, Mısır", "E) Sırbistan, Karadağ, Romanya"],
        correctAnswerIndex: 4,
    ...
    {
        question: "Ermeni sorununun ilk kez uluslararası hale geldiği antlaşma hangisidir?",
    ...
    {
        question: "Berlin'de Bulgaristan'ın üçe bölünerek Osmanlı'ya bırakılmasının yorumu nedir?",
        options: [
            "A) Rusya sıcak denizlere inmiştir",
            "B) Karadeniz tarafsız kalmıştır",
            "C) Yunanistan bağımsız olmuştur",
            "D) Meşrutiyet ilan edilmiştir",
            "E) Rusların sıcak denizlere inmesi engellenmiştir"
        ],
        correctAnswerIndex: 4,
        explanation: "Ayastefanos'a göre değişen bu madde ile Rusların sıcak denizlere inmesi engellenmiştir."
    },
    {
        question: "Berlin Antlaşması'nda Bosna Hersek ve Teselya ile ilgili hangisi doğrudur?",
        options: [
    ...
    {
        question: "93 Harbi'nden sonra İngiltere'nin Osmanlı toprak bütünlüğünü korumaktan vazgeçmesi üzerine Osmanlı hangi devletle yakınlaşmıştır?",
    ...
    {
        question: "1897 Dömeke Meydan Muharebesi ile ilgili hangisi doğrudur?",
        options: [
            "A) Osmanlı yenilmiş, Girit kaybedilmiştir",
            "B) Kırım Savaşı'nın parçasıdır",
            "C) Rusya ile yapılmıştır",
            "D) Osmanlı–Yunanistan arasında yapılmış, Osmanlı zaferi ile sonuçlanmıştır",
    ...
    {
        question: "1878–1908 arasındaki 30 yıllık dönemin adı nedir?",
        options: ["A) Restorasyon", "B) Tanzimat", "C) Meşrutiyet'in ikinci devri", "D) Islahat", "E) İstibdat Dönemi"],
        correctAnswerIndex: 4,
        explanation: "93 Harbi bahane edilerek meclis feshedilmiş, 1878–1908 İstibdat Dönemi olmuştur."
    },
    {
        question: "II. Meşrutiyet'in ilanında etkili olan gelişmeler hangileridir?",
        options: [
            "A) Navarin ve Sinop",
            "B) Viyana Kongresi ve Şark Sorunu",
            "C) Dömeke ve Halepa",
            "D) Reval Görüşmeleri ve Hürriyet Taburlarının isyanı",
    ...
    {
        question: "Osmanlı'nın Kuzey Afrika'da kaybettiği ilk toprak hangisidir?",
    ...
    {
        question: "1881'de Tunus'u işgal eden devlet hangisidir?",
        options: ["A) Fransa", "B) İtalya", "C) İngiltere", "D) Almanya", "E) İspanya"],
        correctAnswerIndex: 0,
        explanation: "Tunus 1881'de Fransa tarafından işgal edilmiştir."
    },
    {
        question: "1882'de Mısır'ı işgal eden devlet hangisidir?",
        options: ["A) Fransa", "B) İngiltere", "C) İtalya", "D) Rusya", "E) Avusturya"],
        correctAnswerIndex: 1,
        explanation: "Mısır 1882'de İngiltere tarafından işgal edilmiştir."
    },
    {
        question: "Trablusgarp'ın İtalya'ya kaybedildiği antlaşma hangisidir?",
    ...
    {
        question: "Aşağıdakilerden hangisi «ilk isyan eden azınlık / ilk imtiyaz alan azınlık / ilk bağımsız ayrılan azınlık» eşleşmesini doğru verir?",
        options: [
            "A) Yunan — Sırp — Bulgar",
            "B) Rum — Sırp — Yunan",
            "C) Sırp — Yunan — Sırp",
