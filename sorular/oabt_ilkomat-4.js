// sorular/oabt_ilkomat-4.js - Sayılar
window.oabt_ilkomat_4_sorulari = [
{
    "question": "1 neden asal değildir?",
    "options": ["A) Negatif olduğu için", "B) Rasyonel olduğu için", "C) Böleni olmadığı için", "D) Tam iki pozitif bölene sahip değildir", "E) Çift olduğu için"],
    "correctAnswerIndex": 3,
    "explanation": "Asal: tam iki pozitif bölen; 1'in tek böleni kendisidir."
},
{
    "question": "√2'nin rasyonel olmamasının anlamı nedir?",
    "options": ["A) Asal olduğu için", "B) p/q (p,q tam, q≠0) biçiminde yazılamaz", "C) Kesir gibi göründüğü için rasyoneldir", "D) Ondalık sonlu olduğu için", "E) Kare olmadığı için tam sayıdır"],
    "correctAnswerIndex": 1,
    "explanation": "Klasik kanıt: en sade kesir varsayımı çelişki."
},
{
    "question": "EBOB(a,b)·EKOK(a,b) eşitliği nedir?",
    "options": ["A) a+b", "B) a-b", "C) a/b", "D) 1", "E) |a·b|"],
    "correctAnswerIndex": 4,
    "explanation": "Asal çarpan üslerinin min/max kuralından gelir."
},
{
    "question": "Kesrin bölüm anlamı hangisidir?",
    "options": ["A) Yalnızca pasta dilimi", "B) Yalnızca oran", "C) Yalnızca olasılık", "D) Yalnızca yüzde", "E) a/b = a÷b"],
    "correctAnswerIndex": 4,
    "explanation": "Çoklu anlam: parça-bütün, ölçme, paylaşım, oran."
},
{
    "question": "%20 artış sonra %20 azalış net sonuç ne olur?",
    "options": ["A) Değişmez", "B) %40 azalış", "C) %20 azalış", "D) %4 artış", "E) Net %4 azalış (çarpımsal 0,96)"],
    "correctAnswerIndex": 4,
    "explanation": "1,20·0,80=0,96; ardışık yüzde tuzak."
},
{
    "question": "2 tek çift asal olmasının nedeni nedir?",
    "options": ["A) 2 asal değildir", "B) Çift sayılar asal olamaz kuralı yoktur ve 2 istisna değil tanımdır", "C) 2 rasyonel olmadığı için", "D) 2'den başka çift pozitif tam sayı 2'ye bölünür", "E) 2 tek sayıdır"],
    "correctAnswerIndex": 3,
    "explanation": "Asallık çift-tek ile değil bölen sayısıyla tanımlanır."
},
{
    "question": "10^3 · 10^{-5} sonucu nedir?",
    "options": ["A) 10^{-15}", "B) 10^2", "C) 1", "D) 10^{-2}", "E) 10^8"],
    "correctAnswerIndex": 3,
    "explanation": "Üs toplanır: 3+(-5)=-2."
},
{
    "question": "Ters orantıda x artınca y nasıl değişir?",
    "options": ["A) y aynı oranda artar", "B) y sabit kalır", "C) y kare artar", "D) y üssel artar", "E) xy=k sabit kalacak biçimde y azalır"],
    "correctAnswerIndex": 4,
    "explanation": "Doğru orantı y=kx, ters xy=k."
},
{
    "question": "0,25 kesir ve yüzde karşılığı hangisidir?",
    "options": ["A) 2/5 ve %20", "B) 1/5 ve %25", "C) 4/1 ve %250", "D) 1/4 ve %25", "E) 1/25 ve %4"],
    "correctAnswerIndex": 3,
