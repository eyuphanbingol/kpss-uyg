// sorular/oabt_ilkomat-1.js - Analiz
window.oabt_ilkomat_1_sorulari = [
{
    "question": "Fonksiyonun tanımı hangisidir?",
    "options": ["A) Görüntü kümesi tanım kümesine eşit olmalıdır", "B) Tanım kümesindeki her elemana değer kümesinde tek eleman eşleyen bağıntı", "C) Her bağıntı fonksiyondur", "D) Bir x'e iki y eşlenebilir", "E) Yalnızca doğrusal kurallar"],
    "correctAnswerIndex": 1,
    "explanation": "Dikey doğru testi grafikte tek y ister."
},
{
    "question": "Ters fonksiyonun varlığı için yeterli koşul hangisidir?",
    "options": ["A) Yalnızca sürekli olması", "B) f(0)=0 olması", "C) Polinom olması", "D) Çift fonksiyon olması", "E) Fonksiyonun birebir ve örten olması"],
    "correctAnswerIndex": 4,
    "explanation": "Bijektif fonksiyonların tersi vardır."
},
{
    "question": "lim x→a f(x) = L iken f(a) hakkında ne söylenebilir?",
    "options": ["A) Mutlaka süreksizdir", "B) Türev vardır", "C) f sabittir", "D) f(a) tanımlı olmak zorunda değildir", "E) Mutlaka f(a)=L"],
    "correctAnswerIndex": 3,
    "explanation": "Kaldırılabilir süreksizlikte limit var, f(a) farklı veya tanımsız olabilir."
},
{
    "question": "Türevin geometrik anlamı nedir?",
    "options": ["A) Kirişin uzunluğu", "B) Eğrinin altındaki alan", "C) Fonksiyonun sıfırı", "D) Asimptot", "E) Eğriye teğet doğrunun eğimi"],
    "correctAnswerIndex": 4,
    "explanation": "Anlık değişim oranı teğet eğimidir."
},
{
    "question": "f'(x)>0 olduğu aralıkta f nasıldır?",
    "options": ["A) Artandır", "B) Azalandır", "C) Sabittir", "D) Konkavdır", "E) Süreksizdir"],
    "correctAnswerIndex": 0,
    "explanation": "Birinci türev testi monotonluğu verir."
},
{
    "question": "Newton-Leibniz formülü neyi ifade eder?",
    "options": ["A) Matris determinantını", "B) ∫a^b f = F(b)-F(a) (F'=f)", "C) Türevin çarpım kuralını", "D) Limitin sandviç teoremini", "E) Dizinin monotonluğunu"],
    "correctAnswerIndex": 1,
    "explanation": "Analizin temel teoreminin hesaplama yüzü."
},
{
    "question": "Belirli integralin işaretli alan yorumu neden geometrik alandan farklıdır?",
    "options": ["A) Riemann toplamı kullanılamaz", "B) C sabiti eklenir", "C) Eksen altı bölgeler negatif katkı yapar", "D) Integral her zaman pozitiftir", "E) Alan türeve eşittir"],
    "correctAnswerIndex": 2,
    "explanation": "Geometrik alan için |f| integre edilir."
},
{
    "question": "Lagrange ortalama değer teoremi ne varsayar?",
    "options": ["A) f(a)=f(b) zorunluluğunu", "B) f'nin çift olmasını", "C) İntegralin sıfır olmasını", "D) f'nin [a,b] de sürekli, (a,b) de türevlenebilir olmasını", "E) f'nin polinom olmasını"],
    "correctAnswerIndex": 3,
    "explanation": "Rolle, f(a)=f(b) özel halidir."
},
{
    "question": "Parça tanımlı fonksiyonda süreklilik için ne gerekir?",
    "options": ["A) Türevin sıfır olması", "B) Asimptot olmaması", "C) Fonksiyonun tek olması", "D) Soldan ve sağdan limitlerin f(a) ile eşitliği", "E) Yalnızca f(a) tanımlı olması"],
    "correctAnswerIndex": 3,
