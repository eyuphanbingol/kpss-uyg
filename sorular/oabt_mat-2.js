// sorular/oabt_mat-2.js - Cebir
window.oabt_mat_2_sorulari = [
{
    "question": "Lagrange teoremi neyi söyler?",
    "options": ["A) Halkalar gruptur", "B) Sonlu grupta alt grubun mertebesi grubun mertebesini böler", "C) Her bölen için alt grup vardır", "D) Tüm gruplar Abeldir", "E) Çekirdek her zaman {e}"],
    "correctAnswerIndex": 1,
    "explanation": "Tersi A4'te 6 için başarısız."
},
{
    "question": "Normal alt grubun tanımı hangisidir?",
    "options": ["A) H={e}", "B) H maksimal değil", "C) gHg^{-1}=H her g için (sol ve sağ kosetler eşit)", "D) H değişmeli", "E) H sonlu"],
    "correctAnswerIndex": 2,
    "explanation": "Bölüm grubu ancak normalde tanımlanır."
},
{
    "question": "Cisim aksiyomunu Z neden sağlamaz?",
    "options": ["A) 1 dışında çarpımsal ters yoktur (ör. 2)", "B) Toplama birleşmeli değildir", "C) 0 birimdir", "D) Z kapalı değildir", "E) Z değişmeli değildir"],
    "correctAnswerIndex": 0,
    "explanation": "Q, R, C, Z_p (p asal) cisimdir."
},
{
    "question": "Birinci izomorfizma teoremi nedir?",
    "options": ["A) ker φ = G", "B) im φ = {e}", "C) G/G ≅ G", "D) G/ker φ ≅ φ(G)", "E) G ≅ G×G"],
    "correctAnswerIndex": 3,
    "explanation": "Homomorfizma görüntüsü bölümle izomorf."
},
{
    "question": "F cisimken F[x] hangi yapıdadır?",
    "options": ["A) Cisim (derece ≥1 iken)", "B) Sonlu grup", "C) Sıfır bölensiz olmayan halka", "D) Basit halka değil her zaman cisim", "E) Öklid bölgesi (dolayısıyla PID ve UFD)"],
    "correctAnswerIndex": 4,
    "explanation": "Derece fonksiyonu Öklid ölçüsüdür."
},
{
    "question": "Cebirsel sayı ne demektir?",
    "options": ["A) Rasyonel katsayılı (eşdeğer tam katsayılı) bir polinomun kökü", "B) Yalnızca tam sayı", "C) Yalnızca aşkın", "D) Yalnızca pozitif", "E) Seri toplamı"],
    "correctAnswerIndex": 0,
    "explanation": "π aşkındır, √2 cebirseldir."
},
{
    "question": "Kule kuralı [K:F] için nedir?",
    "options": ["A) Derece 1'e düşer", "B) Galois grubu toplamı", "C) [K:F]=[K:E][E:F] (F⊆E⊆K sonlu genişlemeler)", "D) Toplamsal derece", "E) [K:F]=[K:E]+[E:F]"],
    "correctAnswerIndex": 2,
    "explanation": "Vektör uzayı tabanı çarpımı."
},
{
    "question": "Genel 5. derece polinom neden radikallerle çözülemez?",
    "options": ["A) Kök yoktur C üzerinde", "B) Derece 5 polinom çarpanlara ayrılmaz asla", "C) Kartan formülü her zaman vardır", "D) Abel savı yalnızca kareler içindir", "E) S5 (veya A5) çözülebilir grup değildir; Galois teorisi engeller"],
    "correctAnswerIndex": 4,
    "explanation": "Abel-Ruffini."
},
{
    "question": "Sonlu cisim F_q çarpımsal grubu nasıldır?",
    "options": ["A) Toplamsal gruba eşit", "B) Sikliktir (F_q)*", "C) Basit Abel değildir", "D) S2 ile izomorf zorunlu", "E) Sonsuzdur"],
    "correctAnswerIndex": 1,
