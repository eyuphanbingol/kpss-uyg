// sorular/oabt_sinif-7.js - Hayat Bilgisi Öğretimi
window.oabt_sinif_7_sorulari = [
{
    "question": "Hayat bilgisi hangi sınıflardadır?",
    "options": ["A) Yalnızca ortaokul", "B) Yalnızca lise", "C) Yalnızca okul öncesi zorunlu aynı ad", "D) 1, 2 ve 3. sınıf", "E) Yalnızca 4"],
    "correctAnswerIndex": 3,
    "explanation": "Bütünleşik ilkokul başı."
},
{
    "question": "4. sınıfta ne olur?",
    "options": ["A) Türkçe kalkar", "B) BE kalkar", "C) Fen ve sosyal bilgiler ayrışır", "D) Hayat bilgisi 8. sınıfa kadar", "E) Matematik kalkar"],
    "correctAnswerIndex": 2,
    "explanation": "Program yapısı."
},
{
    "question": "Yakından uzağa ilkesi neyi ister?",
    "options": ["A) Aile-okul-mahalle sonra ülke-dünya", "B) Önce kıtalar sonra adın", "C) Önce gezegen sonra ev", "D) Önce tarih 1453 sonra aile", "E) Önce NATO sonra arkadaş"],
    "correctAnswerIndex": 0,
    "explanation": "Yaşam dünyası."
},
{
    "question": "Konuşma halkasının işlevi nedir?",
    "options": ["A) Yaşantı paylaşımı ve dil", "B) Ezber marş", "C) Ceza", "D) Test", "E) Sessizlik yemini"],
    "correctAnswerIndex": 0,
    "explanation": "Duyuşsal+dil."
},
{
    "question": "Afet eğitimi neden hayat bilgisindedir?",
    "options": ["A) Yalnızca müzik", "B) Yaşam becerisi ve yurttaşlık", "C) Yalnızca coğrafya lise", "D) Yalnızca fizik formül", "E) Yalnızca tarih yılı"],
    "correctAnswerIndex": 1,
    "explanation": "Deprem çantası."
},
{
    "question": "Örtük program örneği hangisidir?",
    "options": ["A) Ders kitabı sayfa", "B) Yazılı tarife", "C) Öğretmenin kuyrukta adil durması", "D) Ünite kapak resmi", "E) Kazanım numarası uydurma"],
    "correctAnswerIndex": 2,
    "explanation": "Değer yaşantısı."
},
{
    "question": "Kapsayıcı aile teması nasıl işlenir?",
    "options": ["A) Farklı aile yapılarını yok saymadan", "B) Tek model dayatma", "C) Alay", "D) Soru mahremiyeti ihlali", "E) Notla yargılama"],
    "correctAnswerIndex": 0,
    "explanation": "Hassasiyet."
},
{
    "question": "Performans görevi örneği hangisidir?",
    "options": ["A) Sınıf geri dönüşüm köşesi işletmek", "B) Tek çoktan seçmeli tanım", "C) Yoklama", "D) Nöbet", "E) Punto ezberi"],
    "correctAnswerIndex": 0,
    "explanation": "Alan eğitimi ölçme."
},
{
    "question": "Hayat bilgisinin fen-sosyal yığını olmamasının nedeni nedir?",
    "options": ["A) Sınav olmasın diye", "B) Gezi yasak diye", "C) Çocuğun yaşamını bütün olarak ele alması", "D) Öğretmen kolaylığı", "E) Kitap ince olsun diye"],
    "correctAnswerIndex": 2,
    "explanation": "Disiplinlerarasılık."
},
{
    "question": "2026 ÖABT'de hayat bilgisi öğretimi hangi bloktadır?",
    "options": ["A) Yalnızca ÖABT TDE", "B) Yalnızca DKAB", "C) Alan eğitimi (20 soruluk yapı içinde)", "D) Yalnızca AGS", "E) Yalnızca 30 alan bilgisi tarih ezberi tek"],
    "correctAnswerIndex": 2,
