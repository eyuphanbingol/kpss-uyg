...
function main() {
    ...
    var crops = [
        ...
        { file: "susam.png", title: "SUSAM ÜRETİMİ", urun: "Susam",
            noktalar: [
    ...
    // 21 Haziran — aydınlık kuzeyde daha batıya uzanır (çizgi KB→GD)
    ...
    var pyBody = '<text x="270" y="88" text-anchor="middle" font-size="13" fill="' + C.muted + '" font-family="Segoe UI, sans-serif">15 ve 60 yaş çizgileri çalışma çağını ayırır</text>' +
        ...
        pyr(140, 650, "#3F8F5A", "Gelişmekte", [[0, -95], [28, 0], [22, 80], [-22, 80], [-28, 0]]) +
